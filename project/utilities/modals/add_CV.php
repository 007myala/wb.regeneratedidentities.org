    ...
    <div class="modal-content" style="max-width: 500px !important; margin: 1.75rem auto !important;">
      ...
      <div class="modal-body">
        ...
        while($Available_Names = $query_CL->fetch(PDO::FETCH_ASSOC)){
          if($Available_Names['Field']=="Type_of_Location" || $Available_Names['Field']=="Type_of_Geographic_Area" || $Available_Names['Field']=="Location" || $Available_Names['Field']=="Place_Type" || $Available_Names['Field']=="ID" || $Available_Names['Field']=="Status" ||$Available_Names['Field']=="Message" ||$Available_Names['Field']=="Submitby" |$Available_Names['Field']=="listorder"){
