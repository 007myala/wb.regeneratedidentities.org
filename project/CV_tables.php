                      ...
                      <div class="card bg-danger text-white shadow" style="margin-bottom: 5%;">
                        <div class="card-body">
                            <div class="text-white-50 small">
                              <h3><i class="fas fa-edit"></i> Controlled Vocabularies - All Tables</h3>

                            </div>
                        </div>
                      </div>
                      <p>Select below to view and edit controlled vocabulary terms: </p>
                      <div class="row">
                      <?php

                      $q1="SELECT * FROM `CV_tables` ORDER BY `Display`";
                          ...
                          <div class="col-xl-2 col-md-6 mb-12">
                            <div class="card bg-secondary text-white shadow">
                              ...
                              <div class="card-body" style="height: 100px !important;">
                                ...
                                <h5 class="text-white"><?php echo $tables['Display'];?></h5>
                              </div>

                              <a class="btn btn-warning float-right" href="CV_update.php?table=<?php echo $tables['TableName'];?> "><i class="fas fa-table"></i> View</a>
                              <a class="btn btn-primary float-right" href="log_CV.php?table=<?php echo $tables['TableName'];?>"><i class="fas fa-clipboard-check"></i> Log</a>
