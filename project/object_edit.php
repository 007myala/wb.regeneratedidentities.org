            ...
            <div class="col-xl-3 col-md-12 mb-12">
              <!--Options-->
               ...
               <div class="col-xl-12 col-md-12 mb-12">
                    <a  class="btn btn-md btn-danger" href="objects_person.php?personID=<?php echo $_GET['personID'];?>&page_m=<?php echo $page_m;?>&pCnt=<?php echo $pCnt;?>&pID=<?php echo $pID;?>"> <i class="fas fa-long-arrow-alt-left"></i>  Back</a>
                </div>
             </div><br><br>
             <hr>
